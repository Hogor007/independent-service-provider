    ...
    <div>
      ...
      <div className="container mx-2 md:w-2/4 md:mx-auto mt-6">
        ...
        <p className="border-4 p-4 rounded-md mt-4 font-medium text-base">
          Authentication is the process of identifying users by validating who they claim they are, whereas authorisation is the process of creating a user's rights and privileges. Both methods are critical in protecting sensitive data assets against breaches and illegal access.
        </p>
        <br />
        <h1>
          <strong>
